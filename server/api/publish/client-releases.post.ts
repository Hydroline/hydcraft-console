...
import { clientReleaseSchema } from '../../utils/client-updates/contracts'
import { createClientRelease } from '../../utils/client-updates/service'
...
export default defineEventHandler(async (event) => {
	...
	const release = await createClientRelease(
		clientReleaseSchema.parse(await readBody(event)),
	)
