...
import { completeClientMigrationCandidate } from '../../../utils/client-updates/service'
...
export default defineEventHandler(async (event) => {
	...
	const candidate = await completeClientMigrationCandidate(
	...
	return { ...candidate, packageSize: Number(candidate.packageSize) }
})
